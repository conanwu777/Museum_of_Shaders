...
Cube::Cube(Shader& sha, Camera& c, float x, float y, float z, float sX, float sY, float sZ, char *tex) : RenderObject(sha, c, x, y, z, sX, sY, sZ){
	...
	int arrInd[] = {
		8,9,11,9,10,11,3,2,7,2,6,7,0,3,4,3,4,7,2,1,6,1,5,6,1,5,0,0,5,4,13,12,14,14,15,12
	};
